...
<form class="form-horizontal span6  wow fadeInDown" action="controller.php?action=add" method="POST" enctype="multipart/form-data" autocomplete="off" onsubmit="return validate_fields()">
  ...
  <div class="form-group">
    <div class="col-md-8">
      <label class="col-md-4 control-label" for="SKU">MedicationID:</label>
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        <select class="form-control input-sm" id="PatientID" name="PatientID" required>
          <option value="">Select Patient</option>
          <?php
          // Query to get a list of patients from your patients table
          $patientQuery = "SELECT * FROM tblpatients";
          $mydb->setQuery($patientQuery);
          $patients = $mydb->loadResultList();

          foreach ($patients as $patient) {
            echo '<option value="' . $patient->PatientID . '">' . $patient->Lname . '</option>';
          }
          ?>
        </select>
      </div>
  ...
  <div class="form-group">
    <div class="col-md-8">
      <label class="col-md-4 control-label" for="Services">MedicationName:</label>
  ...
  <div class="form-group">
    <div class="col-md-8">
      <label class="col-md-4 control-label" for="Description">Level:</label>
  ...
  <div class="form-group">
    <div class="col-md-8">
      <label class="col-md-4 control-label" for="Description">Indication:</label>
