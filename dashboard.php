    ...
    var calendar = $('#calendar').fullCalendar({
      ...
      select: function(start, end, allDay) {
        ...
        $("#saveappointment").click(function() {
          ...
          var title = patients + ' / ' + services + ' / ' + dentists; 
          ...
          if (title) {
            ...
            $.ajax({
              ...
              data: {
                title: title,
                start: start + ' ' + appointmentsTime,
                end: start + ' ' + appointmentsTime
              },
              success: function() {
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal span6">
          ...
          <div class="form-group">
            <div class="col-md-12">
              <select class="form-control select2" style="width: 100%" id="dentists" name="dentists" required>
