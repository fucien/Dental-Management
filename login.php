...
if(isset($_SESSION['ADMIN_USERID'])){
 ...
 <style type="text/css">
        body{
        background: #ff91d8;
          background: -webkit-linear-gradient(left, #75e3f0, #ff91d8);
          background: -o-linear-gradient(left, #75e3f0, #ff91d8);
          background: -moz-linear-gradient(left, #75e3f0, #ff91d8);
          background: linear-gradient(left, #75e3f0, #ff91d8);
